      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">2.1. Date furnizate direct de tine</h3>
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">2.2. Date colectate automat</h3>
            <ul className="list-disc list-inside space-y-2 text-gray-700">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">2.3. Date din integrări (când folosești produsul)</h3>
            <ul className="list-disc list-inside space-y-2 text-gray-700">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">3. Cum Folosim Datele</h2>
            <ul className="list-disc list-inside space-y-2 text-gray-700">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">4. Cum Protejăm Datele</h2>
            <ul className="list-disc list-inside space-y-2 text-gray-700">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">5. Partajare Date cu Terți</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">8. Retenție Date</h2>
            <ul className="list-disc list-inside space-y-2 text-gray-700">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">9. Transfer Date Internaționale</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">10. Modificări Politică</h2>
            <p className="text-gray-700 leading-relaxed">
