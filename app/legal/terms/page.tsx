    ...
    <main className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">3. Eligibilitate</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">4. Cont Utilizator</h2>
            
            <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">4.1. Creare Cont</h3>
            <p className="text-gray-700 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">4.2. Suspendare & Închidere Cont</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">5. Utilizare Acceptabilă</h2>
            
            <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">5.1. Poți să:</h3>
            <ul className="list-disc list-inside space-y-2 text-gray-700">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">5.2. NU poți să:</h3>
            <ul className="list-disc list-inside space-y-2 text-gray-700">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">7. Prețuri & Plăți</h2>
            <p className="text-gray-700 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">7.1. Facturare</h3>
            <ul className="list-disc list-inside space-y-2 text-gray-700">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">7.2. Rambursări</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">8. Garanții & Limitări Răspundere</h2>
            
            <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">8.1. Serviciul &#34;AS IS&#34;</h3>
            <p className="text-gray-700 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">8.2. Limitare Răspundere</h3>
            <p className="text-gray-700 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">8.3. Uptime & SLA</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">9. Încetare Serviciu</h2>
            
            <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">9.1. Anulare de către tine</h3>
            <p className="text-gray-700 leading-relaxed">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">9.2. Încetare de către noi</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">10. Legislație Aplicabilă</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">11. Modificări Termeni</h2>
            <p className="text-gray-700 leading-relaxed">
